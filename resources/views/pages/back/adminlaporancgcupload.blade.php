      ...
      <div class="col-sm-10" style="background-color:#fff">
        ...
        <div class="title">
          ...
          <br>
            ...
            <div style="width: 80s%">
              <div class="content">
                <form action="buatlaporancgcaksi" method="post" enctype="multipart/form-data">
          ...
          <div style="text-align:center">
                <input type="submit" style="color: black;width: 300px;" name="Submit" value="Upload Laporan cgc">
                {{ csrf_field() }}
