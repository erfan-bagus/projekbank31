...
<section class="homepage">
  ...
  <div class="row">
    ...
    <div class="col">
      ...
      <button class="w3-bar-item w3-button aktif"  onclick="location.href='{{URL::route('simulasi')}}';" style="background-color:#fff;width:100%;padding: 20px 0;">
      </a>
    ...
    <div class="col">
      ...
      <button class="w3-bar-item w3-button"onclick="location.href='{{URL::route('kontakkami')}}';"  style="background-color:#fff;width:100%;padding: 20px 0;">
      </a>
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      <div id="news-top-carousel" class="owl-carousel">
        @foreach ($beritaatas as $berita)
          <div class="card">
            <img style="max-height:200px;" class="card-img-top" src="{{ asset('gambarberita')}}/{{$berita->gambarberita}}" alt="{{$berita->judul}}">
            <div class="card-body">
              <h5 class="card-title"><b>{{$berita->judul}}</b></h5>
              <div class="someDiv">
              <p class="card-text" style="color:grey;">{{$berita->konten}}</p>
            </div>
              <a href="berita/{{$berita->id}}" class="btn btn-warning btn-sm">Info Selengkapnya</a>
            </div>
          </div>
        @endforeach
      </div>
    ...
    <div class="col-lg-12" style="text-align:center;">
      ...
      <a href="beritalainnya">
        <button class="btn btn-warning" style="margin-left:0px;width:20%"><b>LAINNYA </b> </button>
      </a>
    </div>
  </div>
      ...
      <div class="col-lg-8">
        ...
        <div class="list-group">
          @foreach ($beritabawah as $berita)
            <a href="pengumuman/{{$berita->id}}" class="list-group-item list-group-item-action">{{$berita->judul}}</a>
          @endforeach
