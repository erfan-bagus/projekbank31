      ...
      <div class="col-sm-10" style="background-color:#fff">
        ...
        <div class="title">
          ...
          <br>
            ...
            <div style="width: 80s%">
              <div class="content">
                <form action="buatpengumumanaksi" method="post" enctype="multipart/form-data">
            ...
            <diV>
          <div style="text-align:center">
                <input type="submit" style="color: black;width: 200px;" name="Submit" value="Buat pengumuman">
                {{ csrf_field() }}
